...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Anton Jackson-Smith"
    user-mail-address "anton@dyingstar.net")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/acjs/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/acjs/bin" "/profile/bin" "/Users/acjs/.npm-packages/bin" "/Users/acjs/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
